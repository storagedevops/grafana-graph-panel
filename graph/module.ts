...
class GraphCtrl extends MetricsPanelCtrl {
  ...
  dataWarning: any;
  colors: any = ['#299c46', 'rgba(237, 129, 40, 0.89)', '#d44a3a'];
  subTabIndex: number;
  ...
  panelDefaults = {
    ...
    percentage: false,
    // type of pattern to display on bars
    barsPattern: 'plain',
    // display series bar charts as horizontal
    barsHorizontal: false,
    // display the value as a label of the graph point
    valueLabels: {
      show: false
    },
    // legend options
    ...
    seriesOverrides: [],
    thresholds: [],
    // Enables coloring thresholds on line and bar charts
    coloring: false,
    // Coloring threshold default values
    colors: ['#299c46', 'rgba(237, 129, 40, 0.89)', '#d44a3a'],
    // Color threshold string (comma separated)
    colorThresholds: '',
  };
