    ...
    this.show = function(pos, item) {
      ...
      if (allSeriesMode) {
        ...
        for (i = 0; i < seriesHoverInfo.length; i++) {
          ...
          seriesHtml += '<i class="fa legend-icon ' + series.legendIcon + '" style="color:' + hoverInfo.color +';"></i> ' + hoverInfo.label + ':</div>';
      ...
      // single series tooltip
        ...
        group += '<i class="fa legend-icon ' + series.legendIcon + '" style="color:' + item.series.color +';"></i> ' + series.aliasEscaped + ':</div>';
